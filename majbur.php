<?php
define("UZKOD","5571503607:AAHvem3lFbtFpSG7AV6OEKslPDROhA64wpw");
$admin = "1215424881";
...
🌐 _Bu bot guruhga kim qancha odam qo'shganligini aytib beruvchiva kanalga a'zo bo'lmasa guruhda yoza olmaslikni ta'minlaydigan robot. Botni admin qilib tayinlashni unutmang!_
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"📲 Kanalimiz",'url'=>"t.me/php_own"],['text'=>"👥 Guruhimiz",'url'=>"t.me/php_owners"]]
]
])
]);
}else{
...
'chat_id'=> $cid,
'parse_mode'=>"html",
'text'=>"🔵 <b>Kechirasiz</b> <a href='tg://user?id=$cid'>$name</a> <b>botdan to'liq foydalanish uchun</b> <a href='t.me/php_own'>@php_own</a> <b>kanaliga a'zo bo'ling va tekshirish tugmasini bosing!

📛 Agar kanaldan chiqib ketsangiz bot sizning guruhda ishlamay qoladi.</b>",
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"➕ A'zo bo'lish",'url'=>"t.me/php_own"]],
...
'text'=>"📛 Siz @php_own kanalimizga a'zo bo'lmadingiz!",
'show_alert'=>true,
]);
}
}
...
if ($tx == "/mymembers" or $tx == "/mymembers@MajburBot"){
if ($cty == "supergroup"){
if (!$replyid){
bot ('sendmessage', [
'chat_id'=> $cid,
